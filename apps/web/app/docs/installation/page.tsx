...
const Installation = () => {
  return (
    <DocsContainer>
      ...
      <DocsText>
        Get started with PaperDB by installing the SDK in your project. You can
        use npm, pnpm, or yarn.
      </DocsText>
      <DocsCallout type="info">
        <DocsText className="mb-0">
          <strong>🧪 TypeScript Required:</strong> PaperDB is designed for
      ...
      <DocsCodeBlock>{`pnpm add paperdb`}</DocsCodeBlock>
      <DocsHeading level={3}>Install with yarn</DocsHeading>
      <DocsCodeBlock>{`yarn add paperdb`}</DocsCodeBlock>
    </DocsContainer>
  );
};
