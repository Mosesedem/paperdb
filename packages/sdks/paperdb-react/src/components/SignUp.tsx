/**
 * Sign Up component for PaperDB React
 * A pre-built, customizable sign-up form
 */
...
const defaultStyles: SignUpProps["styles"] = {
  container: {
    maxWidth: "400px",
    margin: "0 auto",
    padding: "2rem",
...
export function SignUp({
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      onError?.(err instanceof Error ? err : new Error("Sign up failed"));
    }
  };
  ...
  return (
    <div className={className} style={mergedStyles.container}>
      ...
      <form onSubmit={handleSubmit} style={mergedStyles.form}>
        ...
        >
          {isLoading ? "Creating account..." : labels.submit || "Sign Up"}
        </button>
      </form>
      ...
      {signInUrl && (
        ...
        >
          {labels.signInLink || "Already have an account?"}{" "}
          <a href={signInUrl} style={{ color: "#0070f3" }}>
            Sign in
          </a>
        </p>
      )}
